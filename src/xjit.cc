...
xOperand *xjit_b(const xOperand *base) {
  return new xOperand(new Xbyak::Address(Xbyak::util::ptr[*static_cast<const Xbyak::Reg *>(base->op)]));
}
xOperand *xjit_bd(const xOperand *base, uint32_t disp) {
  return new xOperand(new Xbyak::Address(Xbyak::util::ptr[*static_cast<const Xbyak::Reg *>(base->op) + disp]));
}
xOperand *xjit_bdx(const xOperand *base, uint32_t disp, const xOperand *index) {
  return new xOperand(new Xbyak::Address(Xbyak::util::ptr[*static_cast<const Xbyak::Reg *>(base->op) + *static_cast<const Xbyak::Reg *>(index->op) + disp]));
}
xOperand *xjit_bdxs(const xOperand *base, uint32_t disp, const xOperand *index, uint8_t scale) {
  return new xOperand(new Xbyak::Address(Xbyak::util::ptr[*static_cast<const Xbyak::Reg *>(base->op) + *static_cast<const Xbyak::Reg *>(index->op) * scale + disp]));
}

xOperand *xjit_b32(const xOperand *base) {
  return new xOperand(new Xbyak::Address(Xbyak::util::dword[*static_cast<const Xbyak::Reg *>(base->op)]));
}
xOperand *xjit_bd32(const xOperand *base, uint32_t disp) {
  return new xOperand(new Xbyak::Address(Xbyak::util::dword[*static_cast<const Xbyak::Reg *>(base->op) + disp]));
}
xOperand *xjit_bdx32(const xOperand *base, uint32_t disp, const xOperand *index) {
  return new xOperand(new Xbyak::Address(Xbyak::util::dword[*static_cast<const Xbyak::Reg *>(base->op) + *static_cast<const Xbyak::Reg *>(index->op) + disp]));
}
xOperand *xjit_bdxs32(const xOperand *base, uint32_t disp, const xOperand *index, uint8_t scale) {
  return new xOperand(new Xbyak::Address(Xbyak::util::dword[*static_cast<const Xbyak::Reg *>(base->op) + *static_cast<const Xbyak::Reg *>(index->op) * scale + disp]));
}

xOperand *xjit_eax_(void) { return new xOperand(new Xbyak::Reg32(Xbyak::util::eax)); }
xOperand *xjit_rax_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rax)); }
xOperand *xjit_rbx_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rbx)); }
xOperand *xjit_rcx_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rcx)); }
xOperand *xjit_rdx_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rdx)); }
xOperand *xjit_rsp_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rsp)); }
xOperand *xjit_rbp_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rbp)); }
xOperand *xjit_rsi_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rsi)); }
xOperand *xjit_rdi_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::rdi)); }
xOperand *xjit_r8_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r8)); }
xOperand *xjit_r9_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r9)); }
xOperand *xjit_r10_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r10)); }
xOperand *xjit_r11_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r11)); }
xOperand *xjit_r12_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r12)); }
xOperand *xjit_r13_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r13)); }
xOperand *xjit_r14_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r14)); }
xOperand *xjit_r15_(void) { return new xOperand(new Xbyak::Reg64(Xbyak::util::r15)); }
